 ...
 *
 * For dynamic connectivity, the practical implication of Proposition H and its corollary is 
 * that weighted quick-union is the only one of the three algorithms that can feasibly be used
 * for huge practical problems.
 * 
